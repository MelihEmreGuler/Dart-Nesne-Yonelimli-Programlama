...
void main(List<String> args)async{
  Map<String,dynamic> gelenUser = await idyeGoreKullaniciyiGetir(12345);
  print(gelenUser);

  List<String> kurslar = await usernameyeGoreKurslariGetir(gelenUser["username"]);
  print(kurslar);
  
  String yorum = await ilkKursunIlkYorumunuGetir(kurslar[0]);
  print(yorum);
}
