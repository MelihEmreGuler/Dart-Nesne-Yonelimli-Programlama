class Musteri{
  ...
  void set musteriNoAta(int no){ // basina set yazmamiz disinda herhangi bir fonksiyondan farki yok.
    if(no>300)
      _musteriNo = no;
    else
      return;
 ...
 /*  String get musteriNoSoyle{ //fonksiyon olsaydi parantez ile parametre aldirtirdik ama get fonksiyonu sayesinde direk açılabiliyor.
  ...
  String get musteriNoSoyle => "Musteri No: $_musteriNo"; // fat arrow kullanimi ile getter fonksiyonu.
